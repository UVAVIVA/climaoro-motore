...
1. Scarica il file [`install.bat`](https://github.com/UVAVIVA/climaoro-motore/raw/main/install.bat)
...
1. Scarica il file [`install.sh`](https://github.com/UVAVIVA/climaoro-motore/raw/main/install.sh)
